                            ...
                            <ul>
                                <li>
                                    <form method='post' action='mycart.jsp'>
                                        ...
                                        <input type='submit' class='formbutton' value='Añadir al Carrito'>
                                    </form>
                                </li>
                                <li><a class='button' href='accessorylist.jsp?maker=<c:out value="${console.retailer}"/>&console=<c:out value="${console.key}"/>'>Ver Accesorios</a></li>
                                <li><a class='button' href='review.jsp?productkey=<c:out value="${console.key}"/>'>Comentarios</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
