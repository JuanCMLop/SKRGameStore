...
<%
    ...
    if (!helper.isLoggedin()) {
        session.setAttribute(Constants.SESSION_LOGIN_MSG, "Porfavor inciar sesión!");
    ...
    <div class='cart'>
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <table cellspacing='0'>
                    <tr><th>Pedido Id</th><th>Nom. Cliente</th><th>Fecha Entrega</th><th>Acción</th></tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span><a href='admin_orderdel.jsp?orderid=<c:out value="${order.id}"/>' class='button' onclick = "return confirm('¿Estás seguro de eliminar este pedido?')">Eliminar</a></span>
                            </td>
                        </tr>
                    </c:forEach>               
                </table>
