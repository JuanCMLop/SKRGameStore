...
<%
    ...
    if (orders == null || orders.size() == 0) {
        errmsg = "Aún no tienes un pedido!";
    }
                            ...
                            <tr><td><h5><i>Pedido ID: </i></h5></td><td><c:out value="${order.id}"/></td>
                                <td>
                                    <form action="ordercancel.jsp" method="Post"> 
                                        ...
                                        <input type="submit" value="Cancelar pedido" class="formbutton" onclick = "return confirm('¿Estás seguro de cancelar este pedido?')">     
                                    </form>
                                </td>
                            </tr>
                            <tr><td><h5><i>Nom. Cliente: </i></h5></td><td><c:out value="${order.userName}"/></td><td></td></tr>
                            <tr><td><h5><i>Dirección: </i></h5></td><td><c:out value="${order.address}"/></td><td></td></tr>
                            <tr><td><h5><i>N° Confirmación: </i></h5></td><td><c:out value="${order.confirmationNumber}"/></td><td></td></tr>
