...
<%
    ...
    if (productkey == null || productkey.isEmpty()) {
        errmsg = "Parámetro no válido. No se puede encontrar el producto: " + productkey;
    } else {
...
<section id="content">
    <div class="post">
        <h3 class="title">Revisión del Producto</h3>
        ...
        <div class="entry">
            ...
            <form action='review.jsp' method='POST'>
                ...
                <table>
                    <tr><td>Calificación:</td><td><select name='rating' class='input'><option value='5' selected>5</option><option value='4'>4</option><option value='3'>3</option><option value='2'>2</option><option value='1'>1</option></select></td></tr>
                ...
                <c:otherwise>
                    ...
                    <c:forEach var="review" items="${list}">
                        <table cellspacing='0'>
                            ...
                            <tr><td>Calificación:</td><td><c:out value="${review.rating}"/></td></tr>
