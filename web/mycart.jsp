    ...
    <div class='cart'>
        ...
        <c:choose>
            <c:when test="${list.size() == 0}">
                <h3 style='color:red'>Tu carrito esta vacío!</h3>    
            </c:when>
            <c:otherwise>
                ...
                <table cellspacing='0'>
                    <tr><th>No.</th><th>Nombre</th><th>Precio</th><th>Cant</th><th>SubTotal</th><th>Acción</th></tr>
                        ...
                        <tr>
                            ...
                            <td><span><a href='mycart.jsp?id=<c:out value="${cartitem.itemId}"/>&type=<c:out value="${cartitem.itemType}"/>&quantity=0' class='button3' onclick = "return confirm('¿Estás seguro de eliminar este producto?')\">Eliminar</a></span></td>
                        </tr>
