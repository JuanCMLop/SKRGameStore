...
<section id='content'>
    <h3>Resultado de búsqueda de productos</h3>
    <c:choose>
                            ...
                            <div class="grid_1">
                                ...
                                <div class="special_item_add">
                                    <ul>
                                        ...
                                        <li><a class='button' href='review.jsp?productkey=<c:out value="${product.id}"/>'>Comentarios</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
