...
<%
    ...
    if (address == null || address.isEmpty() || creditcard == null || creditcard.isEmpty()) {
        errmsg = "¡Parámetro no válido! Regrese al carrito para procesar nuevamente!";
    }
    ...
    if (errmsg.isEmpty()) {
        synchronized(session) {
            ...
            if (cart == null) {
                errmsg = "No hay artículos en el carrito de compras, no se puede realizar el pedido!";
            } else {
                list = cart.getItems();
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <table class="order_table">
                    ...
                    <tr><td><h5><i>Dirección: </i></h5></td><td>${order.address}</td></tr>
                    <tr><td><h5><i>N° Confirmación: </i></h5></td><td>${order.confirmationNumber}</td></tr>    
